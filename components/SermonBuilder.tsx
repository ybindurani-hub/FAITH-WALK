                 ...
                 <div className="flex items-center gap-3">
                     ...
                     {!audioUrl ? (
                        <button 
                          ...
                          className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-indigo-600 hover:bg-indigo-50 px-3 py-2 rounded-lg transition-colors border border-indigo-100"
                        >
                           {isAudioLoading ? (
                             <>
